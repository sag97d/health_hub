...
const changeAvailablity = async (req, res) => {
    ...
    try {
        ...
        await doctorModel.findByIdAndUpdate(docId, { availaible: !docData.availaible })
        res.json({ success: true, message: 'Availaibility Chnaged' })
...
// API to mark appointmnet cancel for doctor panel
...
// API to mark appointmnet completed for doctor panel
